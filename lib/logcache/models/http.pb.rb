...
module Logcache
  module Models
    ...
    class HttpStartStop
      ...
      required ::Logcache::Models::UUID, :requestId, 3
      required ::Logcache::Models::PeerType, :peerType, 4
      required ::Logcache::Models::Method, :method, 5
      ...
      optional ::Logcache::Models::UUID, :applicationId, 12
