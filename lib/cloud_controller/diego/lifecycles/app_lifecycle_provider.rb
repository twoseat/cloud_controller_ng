...
module CloudController
  class AppLifecycleProvider
    TYPE_TO_LIFECYCLE_CLASS_MAP = {
      CloudController::Lifecycles::BUILDPACK => AppBuildpackLifecycle,
      CloudController::Lifecycles::DOCKER    => AppDockerLifecycle
    }.freeze
    DEFAULT_LIFECYCLE_TYPE = CloudController::Lifecycles::BUILDPACK
