  ...
  module Encryptor
    ...
    module FieldEncryptor
      ...
      def update_encryption_key
        ...
        db.transaction do
          (self.class.encrypted_field_names || []).each do |field|
      ...
      module ClassMethods
        def encrypted_field_names
          if self.superclass.respond_to? :encrypted_field_names
            encrypted_fields.+(self.superclass.encrypted_field_names)
          else
            encrypted_fields
          end
        end
