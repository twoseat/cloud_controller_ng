    ...
    describe 'filtering by app_guid' do
      context 'equals operation (:)' do
        it 'works with a single app guid' do
          ...
          app_model = CloudController::AppModel.make(guid: app_guid)

          route_mapping = CloudController::RouteMappingModel.make(app: app_model, app_port: 1)

          results = AppQuery.filtered_dataset_from_query_params(
            CloudController::RouteMappingModel,
            CloudController::RouteMappingModel.dataset,
      ...
      context 'IN operation' do
        it 'works for IN with a single app guid' do
          ...
          route_mapping_1 = CloudController::RouteMappingModel.make(app: app_model, app_port: 1)
          route_mapping_2 = CloudController::RouteMappingModel.make(app: app_model, app_port: 2)
          CloudController::RouteMappingModel.make(app_guid: 'different_app_guid')
        ...
        it 'works for IN with multiple app guids' do
          ...
          app_model1 = CloudController::AppModel.make(guid: app_guid1)
          route_mapping_1 = CloudController::RouteMappingModel.make(app: app_model1, app_port: 1)
          route_mapping_2 = CloudController::RouteMappingModel.make(app: app_model1, app_port: 2)

          app_guid2 = 'some_app_guid2'
          app_model2 = CloudController::AppModel.make(guid: app_guid2)
          route_mapping_3 = CloudController::RouteMappingModel.make(app: app_model2, app_port: 3)
