  ...
  describe '#to_hash' do
    ...
    context 'for a managed service instance' do
      let(:service_instance) do
        CloudController::ManagedServiceInstance.make(service_plan: service_plan, tags: ['meow'])
      end
      ...
      let(:service) { CloudController::Service.make(tags: ['relational', 'mysql']) }
    ...
    context 'for a provided service instance' do
      let(:service_instance) { CloudController::UserProvidedServiceInstance.make(tags: ['wonderful', 'the-best']) }
