...
module VCAP::RestAPI
  RSpec.describe VCAP::RestAPI::Query do
    ...
    describe 'semicolon escaping' do
      let!(:one_semi) { CloudController::TestModel.make(unique_value: 'one_semi;', required_attr: true) }
      let!(:multiple_semi) { CloudController::TestModel.make(unique_value: 'two;;semis and one;semi') }
      ...
      describe '#filtered_dataset_from_query_params' do
        it 'matches with a semicolon at the end' do
          ...
          ds = Query.filtered_dataset_from_query_params(CloudController::TestModel, CloudController::TestModel.dataset, queryable_attributes, q: q)
