      ...
      RSpec.describe LifecycleProtocol do
        ...
        it_behaves_like 'a lifecycle protocol' do
          ...
          let(:staging_details) do
            Diego::StagingDetails.new.tap do |details|
              ...
              details.lifecycle = instance_double(CloudController::DockerLifecycle)
            end
          end
        end
        ...
        describe '#desired_lrp_builder' do
          ...
          it 'creates a diego DesiredLrpBuilder' do
            expect(CloudController::Diego::Docker::DesiredLrpBuilder).to receive(:new).with(
              config,
              builder_opts,
            )
        ...
        describe '#task_action_builder' do
          ...
          it 'creates a diego TaskActionBuilder' do
            expect(CloudController::Diego::Docker::TaskActionBuilder).to receive(:new).with(
              config,
              task,
              lifecycle_data,
            )
