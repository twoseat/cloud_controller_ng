    ...
    module Buildpack
      RSpec.describe LifecycleProtocol do
        ...
        before do
          ...
          CloudController::Buildpack.create(name: 'ruby', stack: 'potato-stack', key: 'ruby-buildpack-key', position: 2)
        ...
        describe '#lifecycle_data' do
          ...
          let(:buildpack) { nil }
          let(:buildpack_infos) { [BuildpackInfo.new(buildpack, CloudController::Buildpack.find(name: buildpack))] }
          ...
          context 'when the blobstore_url_generator returns nil' do
            ...
            it 'returns an error' do
              expect {
                ...
                CloudController::Diego::Buildpack::LifecycleProtocol::InvalidDownloadUri,
        ...
        describe '#desired_lrp_builder' do
          ...
          it 'creates a diego DesiredLrpBuilder' do
            expect(CloudController::Diego::Buildpack::DesiredLrpBuilder).to receive(:new).with(
              config,
              builder_opts,
            )
