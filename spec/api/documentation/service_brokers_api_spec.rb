...
RSpec.resource 'Service Brokers', type: [:api, :legacy_api] do
  ...
  let!(:service_brokers) { 3.times { CloudController::ServiceBroker.make } }
  let(:service_broker) { CloudController::ServiceBroker.first }
  ...
  describe 'Standard endpoints' do
    ...
    post '/v2/service_brokers' do
      ...
      example 'Create a Service Broker' do
        ...
        validate_response RestAPI::MetadataMessage, parsed_response['metadata']
