shared_context 'permissions' do
  before do
    @org_a = CloudController::Organization.make
    @org_a_manager = CloudController::User.make
    @org_a_member = CloudController::User.make
    @org_a_billing_manager = CloudController::User.make
    @org_a_auditor = CloudController::User.make
    ...
    @space_a = CloudController::Space.make(organization: @org_a)
    ...
    @org_b = CloudController::Organization.make
    @org_b_manager = CloudController::User.make
    @org_b_member = CloudController::User.make
    @org_b_billing_manager = CloudController::User.make
    @org_b_auditor = CloudController::User.make
    ...
    @space_b = CloudController::Space.make(organization: @org_b)
